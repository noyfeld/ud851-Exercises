...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public GreenAdapter(int numberOfItems){
        mItemsQuantity=numberOfItems;
    }

    @Override
    public NumberViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.number_list_item,parent,false);
        NumberViewHolder holder = new NumberViewHolder(itemView);
        return holder;
    }
