...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    public static final int GITHUB_SEARCH_LOADER =39;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle bundle = new Bundle();bundle.putString(SEARCH_QUERY_URL_EXTRA,mUrlDisplayTextView.getText().toString());
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery)){
            mUrlDisplayTextView.setText("there is nothing to search,please put your request word");
            return;
        }
            ...
            return new AsyncTaskLoader<String>(this) {
                ...
                public String loadInBackground() {
                    ...
                    if (searchQueryString!=null && !TextUtils.isEmpty(searchQueryString)){
                        try {
                            return NetworkUtils.getResponseFromHttpUrl(new URL(searchQueryString));
                        } catch (IOException e) {
                            e.printStackTrace();
                            return null;
                        }
